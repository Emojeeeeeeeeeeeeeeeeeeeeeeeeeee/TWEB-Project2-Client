...
export class EmojiMessage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            messageContent: ""
    ...
    render() {
        return (
            <div>
                <textarea rows="5" cols="80" id="input" value={this.state.messageContent} onChange={this.handleChange}></textarea>
                <br />
                <div>{this.translate(this.state.messageContent)}</div>
                <div id="output"></div>
            </div>
        );
    }
